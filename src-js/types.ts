...
// Nodes
export type ParentNode = any;

export type AltNodeMetadata<T extends any> = {
  originalNode: T;
  canBeFlattened: boolean;
  svg?: string;
  base64?: string;
};
export type AltNode<T extends any> = T & AltNodeMetadata<T>;

export type ExportableNode = any;
...
export type StyledTextSegmentSubset = any;
