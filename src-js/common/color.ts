...
export const rgbTo6hex = (color: any): string => {
  const hex =
...
export const rgbTo8hex = (color: any, alpha: number): string => {
 ...
 */
export const rgbToCssColor = (color: any, alpha: number = 1): string => {
 ...
 */
export const isBlack = (color: any, opacity: number = 1): boolean =>
  color.r === 0 && color.g === 0 && color.b === 0 && opacity === 1;

/**
 * Checks if color is white
 */
export const isWhite = (color: any, opacity: number = 1): boolean =>
...
export const processGradientStops = (
  ...
  opacity: number = 1,
  colorFormatter: (color: any, alpha: number) => string,
): string => {
  return stops
    .map((stop) => {
