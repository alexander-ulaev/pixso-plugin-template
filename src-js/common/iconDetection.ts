...
const ICON_PRIMITIVE_TYPES: ReadonlySet<any> = new Set([
  "ELLIPSE",
  "RECTANGLE",
  "STAR",
  "POLYGON",
...
const ICON_COMPLEX_VECTOR_TYPES: ReadonlySet<any> = new Set([
  "VECTOR",
  "BOOLEAN_OPERATION",
]);

// Types that are considered icons regardless of size if they are top-level
const ICON_TYPES_IGNORE_SIZE: ReadonlySet<any> = new Set([
  "VECTOR",
  "BOOLEAN_OPERATION",
  "POLYGON",
  "STAR",
...
const ICON_CONTAINER_TYPES: ReadonlySet<any> = new Set([
  "FRAME",
  "GROUP",
  "COMPONENT",
  "INSTANCE",
...
const DISALLOWED_ICON_TYPES: ReadonlySet<any> = new Set([
  "SLICE",
  "CONNECTOR",
  "STICKY",
  "SHAPE_WITH_TEXT",
...
const DISALLOWED_CHILD_TYPES: ReadonlySet<any> = new Set([
 ...
 */
function hasSvgExportSettings(node: any): boolean {
  const settingsToCheck: ReadonlyArray<any> =
    node.exportSettings || [];
 ...
 */
function checkChildrenRecursively(children: ReadonlyArray<any>): {
 ...
 */
export function isLikelyIcon(node: any, logDetails = false): boolean {
