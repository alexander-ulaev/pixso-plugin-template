...
import { calculateRectangleFromBoundingBox } from "./commonPosition";
import { isLikelyIcon } from "./common/iconDetection";
...
export const processNodePure = async (
  ...
  if (
    ...
    console.log("processNodePure RECTANGLE")
  ...
  if (
    ...
    for (const child of visibleJsonChildren) {
      console.log("processNodePure visibleJsonChildren")
